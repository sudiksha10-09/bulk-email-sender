# Django Settings Template for Docker Deployment
# Add this to your config/settings/production.py or config/settings/base.py
...
CELERY_BEAT_SCHEDULE = {
    'send-pending-campaigns': {
        'task': 'apps.campaigns.tasks.send_pending_campaigns',
